var getsheet = function(){
	...
	BOLDER: new NormalTile(window.base*4, 0, window.base, window.base, 1,1,window.base-2, window.base-2, true),
	TREE: new NormalTile(80,0,17,24, 4, 19, 8, 3, true),
	FIREBALL: new NormalTile(0,128, window.base, window.base, 0,6,16,9, false),
